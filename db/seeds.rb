...
# initial fake kids
kid1 = Student.new(:given_name => "Lillybeth", :surname => "Serrano", :image => "kid1.png", :age => 12, :joined_at => "2012-08-30 12:34:23")
kid1.save()
kid2 = Student.new(:given_name => "Keagan", :surname => "Royce", :image => "kid2.png", :age => 11, :joined_at => "2012-09-27 01:14:23")
kid2.save()
kid3 = Student.new(:given_name => "Trace", :surname => "Kingsley", :image => "kid3.png", :age => 12, :joined_at => "2012-10-28 10:41:26")
kid3.save()
kid4 = Student.new(:given_name => "Raymond", :surname => "Skully", :image => "kid4.png", :age => 11, :joined_at => "2012-11-29 10:13:23")
kid4.save()
